...
namespace Common.Classes
{
    public class Tables        
    {
        public Dictionary<string, Table> AllTables { get; set; } = new Dictionary<string, Table>();
        ...
        public void GenerateTables()
        {
            ...
            Table ss = new Table("sales", "staff", typeof(Employee));
            ...
            Table so = new Table("sales", "orders", typeof(Orders));
